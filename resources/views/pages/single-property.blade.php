...
<body>
    ...
    <div class="single-prop">
        @include('components/prop-component')
        <div class="prop-reports">
            ...
            <div class="table-container">
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td data-label="viewer-id" class="td_details">
                                <p>1473</p>
                            </td>
                            <td data-label="viewer-name" class="price">
                                <p>Johnny Doe</p>
                            </td>
                            <td data-label="date">
                                2-3-2023
                ...
                <div class="blur">
                    <h3>go premium and unlock all viewings</h3>
                    <button class="btn-grey">go premium</button>
                </div>
            </div>
        </div>
    </div>
